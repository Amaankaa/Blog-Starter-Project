...
func (ur *UserRepository) RegisterUser(user domain.User) (domain.User, error) {
	...
	return domain.User{}, errors.New("password must be at least 8 characters with upper, lower, number, and special char")
	}

	//Check if the username already exists
	var existingUsername domain.User
